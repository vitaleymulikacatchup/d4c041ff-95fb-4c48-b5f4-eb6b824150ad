...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Bakteria Coffee Roastery",    description: "Experience premium handcrafted coffee from Bakteria. Direct sourcing, small-batch roasting, expert brewing.",    siteName: "Bakteria",    type: "website",    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34my1kGeblbsCcwUUCcjBY9WFkg/uploaded-1771505618512-apxd95pq.mp4",      alt: "Bakteria Coffee Roastery"
    }]
  },
  twitter: {
    card: "summary_large_image",    title: "Bakteria Coffee Roastery",    description: "Premium handcrafted coffee | Direct sourcing | Small-batch roasting",    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34my1kGeblbsCcwUUCcjBY9WFkg/uploaded-1771505618512-apxd95pq.mp4"]
  },
  robots: {
    index: true,
    follow: true
