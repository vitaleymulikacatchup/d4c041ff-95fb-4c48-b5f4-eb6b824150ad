...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Bakteria Coffee Roastery",    description: "Experience premium handcrafted coffee from Bakteria. Direct sourcing, small-batch roasting, expert brewing.",    siteName: "Bakteria",    type: "website",    images: [{
      url: "https://img.b2bpic.net/free-photo/barista-near-glass-coffee-beans-black-coffee-machine-ambiental-coffee-shop_1268-20260.jpg",      alt: "Bakteria Coffee Roastery"
    }]
  },
  twitter: {
    card: "summary_large_image",    title: "Bakteria Coffee Roastery",    description: "Premium handcrafted coffee | Direct sourcing | Small-batch roasting",    images: ["https://img.b2bpic.net/free-photo/barista-near-glass-coffee-beans-black-coffee-machine-ambiental-coffee-shop_1268-20260.jpg"]
  },
  robots: {
    index: true,
    follow: true
